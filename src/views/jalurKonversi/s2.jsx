...
const FormKonversiS2 = () => {
    ...
    return (
        <>
            <MainCard title="Form Konversi S2">
                <Form
                    form={form}
                    layout='vertical'
                >
                    ...
                    <Form.Item label="Kampus Asal">
                        <Input placeholder="Masukkan Kampus Asal" />
                    </Form.Item>
                    <Form.Item label="NIM Kampus Asal">
                        <Input placeholder="Masukkan NIM Kampus Asal" />
                    </Form.Item>
                    <Form.Item label="Scan Ijazah">
                    ...
                    <Form.Item label="Jalur Pendaftaran">
                        <Input disabled value={"Transfer S2"} />
                    </Form.Item>
